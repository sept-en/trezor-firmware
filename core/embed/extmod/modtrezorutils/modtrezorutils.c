...
#endif
#if BEAM_ONLY
    {MP_ROM_QSTR(MP_QSTR_BEAM_ONLY), mp_const_true},
#else
    {MP_ROM_QSTR(MP_QSTR_BEAM_ONLY), mp_const_false},
#endif
#if ENABLE_BEAM
    {MP_ROM_QSTR(MP_QSTR_ENABLE_BEAM), mp_const_true},
#else
    {MP_ROM_QSTR(MP_QSTR_ENABLE_BEAM), mp_const_false},
#endif
};
