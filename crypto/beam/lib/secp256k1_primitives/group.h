 ...
 * (where infinity means an implicit z = 0). a may not be zero. Constant time.
 */
...
/** Set r equal to the sum of a and b (with b given in affine coordinates). This
   is more efficient than secp256k1_gej_add_var. It is identical to
   secp256k1_gej_add_ge but without constant-time
